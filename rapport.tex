...
Pour éviter les problèmes d'égalités entre nombres flottants et pour tenir compte desdites
...
\begin{figure}
    ...
    \includegraphics[height=.25\textheight]{build/sca2_hksweep_huge_h20k20.png}
...
\begin{figure}
    ...
    \includegraphics[height=.25\textheight]{build/sca2_hksweep_huge_h20k22.png}
    \caption{Scalaires une experience à température infinie $(h, k) = (0, 0)$ pour une grille de
    $N=128$, avec prise en compte des $n=1$ plus proches voisins et une décroissance en $a=1$.}
